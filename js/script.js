document.addEventListener('DOMContentLoaded', function(){
  ...
  ul.addEventListener('dblclick', (event) => {
    ...
    if (clickedElementJob == 'edit'){
     ...
     newInput.dataset.job = 'edit'
     newInput.setAttribute('value',value);
     
     clickedItem.parentElement.insertBefore(newInput, clickedItem);
     clickedItem.parentElement.removeChild(clickedItem);
     newInput.focus();
    }
  ...
  function addDate(){
    ...
    //     year: 'numeric'
    // });
    // displayDate.textContent = formatter.format(new Date());
